...
export const metadata = {
  title: 'Payment Policy - Wanderly Explore World',
  description: 'Read our Payment Policy to learn more about our practices and policies.',
};
...
export default function PaymentPolicyPage() {
  ...
  const breadcrumbData = commonData?.breadcrumbs?.['Breadcrumb_payment-policy'];
  ...
  return (
    <main className="bg-white">
      ...
      <LegalContent data={sectionData.LegalContent?.variants?.WanderlyPaymentPolicy} />
